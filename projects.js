const GITHUB_USERNAME = "efrink29"
fetch('https://api.github.com/users/efrink29/repos')
...
.then(repos => {
    ...
    for(const repo of repos) {
        ...
        cardImage.src = "./assets/Pictures/generic_code_bgrnd.jpg"
        ...
        projectTitle.textcContent = repoName
